...
## Corpus Check
- 249 files · ~154,190 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1681 nodes · 3916 edges · 117 communities (76 shown, 39 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 79 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b89196ea`
...
Cohesion: 0.06
Nodes (58): dynamic, metadata, RunsData(), DisabledActionSlot(), AGENT_COLUMNS, dateFormat, AgentsTableSkeleton(), ROWS (+50 more)

### Community 1 - "cn"
Cohesion: 0.06
Nodes (57): AppSidebar(), NAV, ThemeToggle(), Breadcrumb(), BreadcrumbEllipsis(), BreadcrumbItem(), BreadcrumbLink(), BreadcrumbList() (+49 more)
...
Cohesion: 0.10
Nodes (20): Check, checks, FAILURE_SHAPES, leaks, logRecord, serialized, ingest(), LogEventInput (+12 more)

### Community 4 - "profile-card.tsx"
Cohesion: 0.21
Nodes (10): ChangePasswordForm(), Card(), CardAction(), CardContent(), CardDescription(), CardFooter(), CardHeader(), CardTitle() (+2 more)

### Community 5 - "cookie-import-steps.tsx"
Cohesion: 0.10
Nodes (26): BrowserGuide, BROWSERS, ConnectPlatform, DEFAULT_GUIDE, FIREFOX_ANDROID_STORE, useBrowserGuide(), CopyableUrl(), Note() (+18 more)
...
### Community 7 - "query/runs.ts"
Cohesion: 0.31
Nodes (9): fetchRun(), fetchRuns(), hasActiveRuns(), runDetailQueryOptions(), RunLogs, runsQueryOptions(), useRun(), useRuns() (+1 more)
...
Cohesion: 0.20
Nodes (20): ACCENT, FALLBACK, TERMINAL, AlertDialog(), AlertDialogAction(), AlertDialogCancel(), AlertDialogContent(), AlertDialogDescription() (+12 more)

### Community 11 - "query/agents.ts"
Cohesion: 0.07
Nodes (36): AgentFormDialog(), onOpenChange(), initialModeFor(), AgentFormFields(), AgentStatusToggle(), DeleteAgent(), AgentFormMode, DEFAULT_CONFIG (+28 more)

### Community 12 - "nav-user.tsx"
Cohesion: 0.09
Nodes (24): NavUser(), ProfileUser, ProfileCard(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount() (+16 more)
...
Cohesion: 0.15
Nodes (21): decrypt(), encrypt(), EncryptedPayload, getMasterKey(), CredentialType, persistRotation(), SourceCookies, withSourceCookies() (+13 more)

### Community 15 - "run-detail-header.tsx"
Cohesion: 0.43
Nodes (5): canRetry(), RunDetailHeader(), RunStatusBadge(), RunsTable(), runStatusMeta

### Community 16 - "chat.ts"
Cohesion: 0.11
Nodes (25): attemptPass(), ChatRun, disposition(), PassResult, retryAfterMs(), chatProvider, ChatTask, EXTRACTION_ORDER (+17 more)
...
Cohesion: 0.08
Nodes (42): Brand, BRANDS, faviconFor(), LinkIcon(), secondLevel(), SOURCE_ICON, SourceIcon(), BINARIES (+34 more)
...
Cohesion: 0.08
Nodes (32): ProviderMark(), MODE_LABEL, Phase, phasesFrom(), ProviderChip(), RunModels(), STAGE_BAR, Badge() (+24 more)
...
Cohesion: 0.22
Nodes (17): verifyExtraction(), RunContext, setRunStage(), storage, withRunContext(), codeOf(), descriptionOf(), isPermanent() (+9 more)
...
Cohesion: 0.10
Nodes (20): Agent, authSessions, authUsers, authVerifications, Credential, credentials, NewAgent, NewCredential (+12 more)

### Community 28 - "schemas.ts"
Cohesion: 0.09
Nodes (33): { GET, POST }, app, DELETE, GET, PATCH, POST, PUT, auth (+25 more)

### Community 29 - "lib/runs.ts"
Cohesion: 0.20
Nodes (14): RunData(), relayRuns, RunStatus, sourceLabel(), createRun(), deleteRun(), getRun(), RunDetail (+6 more)

### Community 30 - "extraction/index.ts"
Cohesion: 0.11
Nodes (37): NoExtractionKeyError, runChat(), SkippedModel, compactSchemaForPrompt(), asObject(), buildSystem(), extract(), Extraction (+29 more)
...
Cohesion: 0.20
Nodes (11): AgentsData(), AgentsPage(), dynamic, metadata, SettingsPage(), VaultData(), AgentsTable(), QueryProvider() (+3 more)

### Community 34 - "prompts/page.tsx"
Cohesion: 0.20
Nodes (11): dynamic, metadata, PromptsPage(), PromptCard(), PromptsList(), promptKeys, fetchPrompts(), promptsQueryOptions() (+3 more)
...
Cohesion: 0.13
Nodes (28): PromptsData(), cached(), cacheKeys, client(), get(), globalForCache, invalidate(), keyFor() (+20 more)
...
Cohesion: 0.11
Nodes (27): ACCENT, ModalAccent, ModalProps, ModalSize, SIZE, NewRunDialog(), RetryRun(), Dialog() (+19 more)

### Community 43 - "utils.ts"
Cohesion: 0.14
Nodes (12): Field(), FieldContent(), FieldError(), FieldLegend(), FieldSeparator(), FieldSet(), FieldTitle(), fieldVariants (+4 more)
...
Cohesion: 0.11
Nodes (18): 1. The measurement this exists for, 2. How it is wired, 3. THE MANUAL STEP — read this before touching `warp-egress`, 4. Operating it, 5. Failure modes and what they mean, 6. Security notes, 7. Open questions and honest caveats, 8. Why not `@hoangquyet/ytdown` (+10 more)

### Community 46 - "run-stage-timeline.tsx"
Cohesion: 0.17
Nodes (15): formatFields(), LEVEL_TONE, RunStageLogs(), timeFormat, DOT, formatMs(), RunStageTimeline(), STAGE_ICON (+7 more)
...
Cohesion: 0.40
Nodes (9): buildDocument(), DocNode, FACT_FIELDS, itemLine(), LEAD_FIELDS, sectionFor(), sentence(), stepNote() (+1 more)
...
Cohesion: 0.15
Nodes (15): ExternalLink(), hostOf(), Linkify(), Token, tokenize(), PublishedPanel(), dateFormat, RunTranscript() (+7 more)

### Community 54 - "rays.ts"
Cohesion: 0.27
Nodes (10): RayProviderId, configuredRayIds(), getProvider(), isConfigured(), providers, RayProvider, redirectUri(), stateCookieName() (+2 more)
...
Cohesion: 0.23
Nodes (8): JsonPanel(), onCopy(), useCollapseAll(), JSON_EDITOR_BASE, THEME, JsonInput(), JsonView(), Switch()
...
Cohesion: 0.20
Nodes (13): RelayDocument, factLine(), NotionBlock, richText(), TextOptions, toBlocks(), toNotionBlocks(), buildProperties() (+5 more)
...
Cohesion: 0.15
Nodes (11): ProviderOrderRow, ProviderOrderRowProps, Textarea(), ConnectRail(), RailStep, ConnectStepBody(), ImportSessionDialog(), IMPORT_FORM_ID (+3 more)
...
### Community 67 - "[id]/page.tsx"
Cohesion: 0.22
Nodes (9): DashboardLayout(), dynamic, metadata, Params, RunPage(), QueuePage(), VaultPage(), requireSession() (+1 more)
...
Cohesion: 0.36
Nodes (5): Home(), LandingPage(), marquee, stories, getSessionFromHeaders()
...
### Community 115 - "run-detail-skeleton.tsx"
Cohesion: 0.40
...
## Knowledge Gaps
- **387 isolated node(s):** `$schema`, `enabled`, `clientKind`, `useIgnoreFile`, `src/**` (+382 more)
...
- **Why does `cn()` connect `cn` to `runs-table.tsx`, `profile-card.tsx`, `button.tsx`, `query/agents.ts`, `nav-user.tsx`, `run-detail-header.tsx`, `ingest.ts`, `app/layout.tsx`, `lib/providers.ts`, `add-credential-dialog.tsx`, `shape.ts`, `prompts/page.tsx`, `toast.tsx`, `edit-credential-dialog.tsx`, `utils.ts`, `pagination.tsx`, `run-stage-timeline.tsx`, `run-detail.tsx`, `agent-form-fields.tsx`, `import-session-dialog.tsx`, `run-raw-data.tsx`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `config` connect `config/index.ts` to `cn`, `logger.ts`, `catalog.ts`, `vault.ts`, `queue/worker.ts`, `auth-session.ts`, `chat.ts`, `ingest.ts`, `app/layout.tsx`, `notion.ts`, `rays.ts`, `run-logs.ts`, `admission.ts`, `schemas.ts`, `getDb`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `getDb()` connect `getDb` to `runs-table.tsx`, `agents/page.tsx`, `catalog.ts`, `vault.ts`, `chat.ts`, `evidence.ts`, `lib/runs.ts`, `pipeline.ts`, `admission.ts`, `schemas.ts`, `settings/page.tsx`, `extraction/index.ts`?**
