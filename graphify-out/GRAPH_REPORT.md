...
## Corpus Check
- 290 files · ~235,787 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1859 nodes · 4367 edges · 131 communities (83 shown, 42 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 79 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a77ec39b`
...
Cohesion: 0.16
Nodes (17): AGENT_COLUMNS, dateFormat, TypeBadge(), DataTable(), QueryErrorState(), QueryStatusBar(), updatedAgo(), dateFormat (+9 more)

### Community 1 - "sidebar.tsx"
Cohesion: 0.06
Nodes (41): AppSidebar(), NAV, ProfileUser, ThemeToggle(), Sheet(), SheetContent(), SheetDescription(), SheetFooter() (+33 more)
...
Cohesion: 0.21
Nodes (11): PanelTone, TONE_TILE, ChangePasswordForm(), Card(), CardAction(), CardContent(), CardDescription(), CardFooter() (+3 more)
...
Cohesion: 0.18
Nodes (17): transcriptionProvider, transcriptionProviderIds(), Candidate, candidates(), NoTranscriptionKeyError, runWhisperPair(), shouldTryNextAccount(), WhisperPair (+9 more)
...
Cohesion: 0.12
Nodes (29): DisabledActionSlot(), ACCENT, FALLBACK, QueryStatusBarProps, relative, DeleteRun(), canRetry(), RetryRun() (+21 more)
...
Cohesion: 0.19
Nodes (18): ROWS, DataColumn, QueryStatusBarSkeleton(), ROWS, RunsTableSkeleton(), ScrollPanel(), STICKY_TABLE_HEADER, Skeleton() (+10 more)
...
Cohesion: 0.22
Nodes (8): metadata, dynamic, metadata, SettingsPage(), ShellContent(), ShellHeader(), DashboardNotFoundPanel(), SecurityCard()

### Community 17 - "extraction/index.ts"
Cohesion: 0.06
Nodes (55): NoExtractionKeyError, runChat(), COMPACT_EVIDENCE, compactSchemaForPrompt(), Evidence, EVIDENCE_SCHEMA, EvidenceKind, isEvidence() (+47 more)

### Community 18 - "ingest.ts"
Cohesion: 0.06
Nodes (56): Brand, BRANDS, faviconFor(), LinkIcon(), secondLevel(), SOURCE_ICON, SourceIcon(), BINARIES (+48 more)
...
Cohesion: 0.11
Nodes (12): LoginForm(), metadata, metadata, LandingPage(), marquee, MARQUEE_LOOP, stories, AppConfig (+4 more)
...
Cohesion: 0.10
Nodes (19): Modal(), Tabs(), TabsContent(), TabsList(), tabsListVariants, TabsTrigger(), AddCredentialDialog(), PANEL (+11 more)
...
### Community 28 - "select-credential.tsx"
Cohesion: 0.25
Nodes (15): ChainBadge(), CredentialActiveToggle(), describe(), hasSiblings(), SelectCredential(), providerLabel(), credentialsQueryOptions(), fetchCredentials() (+7 more)

### Community 29 - "chat.ts"
Cohesion: 0.18
Nodes (17): attemptKey(), AttemptOptions, ChatRun, disposition, MAX_CANDIDATES, retryAfterMs(), SkippedModel, KeyAttempt (+9 more)
...
Cohesion: 0.25
Nodes (14): verifyExtraction(), RunContext, setRunStage(), storage, withRunContext(), codeOf(), descriptionOf(), isPermanent() (+6 more)

### Community 34 - "prompts/page.tsx"
Cohesion: 0.20
Nodes (11): dynamic, metadata, PromptsData(), PromptCard(), PromptsList(), CARDS, PromptsSkeleton(), listPrompts() (+3 more)
...
Cohesion: 0.09
Nodes (36): AgentFormFields(), ACCENT, ModalAccent, ModalProps, ModalSize, SIZE, Dialog(), DialogClose() (+28 more)

### Community 43 - "vault.ts"
Cohesion: 0.13
Nodes (32): VaultData(), decrypt(), encrypt(), EncryptedPayload, getMasterKey(), credentials, CredentialType, persistRotation() (+24 more)
...
Cohesion: 0.16
Nodes (16): ProviderMark(), ProviderOrderRow, Badge(), badgeVariants, ProviderCardProps, ProviderPicker(), PROVIDER_MARKS, providerIcon (+8 more)

### Community 53 - "schemas.ts"
Cohesion: 0.06
Nodes (39): app, DELETE, GET, PATCH, POST, PUT, PromptKey, ingest() (+31 more)

### Community 54 - "requireSession"
Cohesion: 0.25
Nodes (10): DashboardCatchAll(), generateMetadata(), Params, sectionTitle(), titleCase(), DashboardLayout(), PromptsPage(), RunPage() (+2 more)
...
Cohesion: 0.21
Nodes (10): dynamic, metadata, VaultActions(), VaultNotices(), credentialKeys, promptKeys, fetchPrompts(), promptsQueryOptions() (+2 more)

### Community 57 - "run-logs.ts"
Cohesion: 0.26
Nodes (11): appendRunLog(), dropRunLogs(), DROPPED, LEVEL_NAME, levelName(), readRunLogsHistory(), SearchHit, key() (+3 more)
...
### Community 60 - "logger"
Cohesion: 0.16
Nodes (17): logger, DocNode, RelayDocument, factLine(), NotionBlock, richText(), TextOptions, toBlocks() (+9 more)

### Community 61 - "runs/page.tsx"
Cohesion: 0.19
Nodes (12): dynamic, metadata, Params, RunData(), dynamic, metadata, QueuePage(), RunsData() (+4 more)
...
### Community 63 - "credentials-table.tsx"
Cohesion: 0.19
Nodes (13): accountEmailFor(), accountNameFor(), dateFormat, displayName(), metaString(), ProviderTile(), ReconnectSession(), RowActions() (+5 more)

### Community 64 - "lib/settings.ts"
Cohesion: 0.24
Nodes (11): attemptPass(), chatProvider, EXTRACTION_ORDER, OLLAMA_CAPABILITIES, providers, AiKeyProviderId, isKeylessProvider(), getExtractionOrder() (+3 more)

### Community 65 - "run-detail.tsx"
Cohesion: 0.06
Nodes (40): JsonPanel(), onCopy(), useCollapseAll(), JSON_EDITOR_BASE, THEME, JsonInput(), JsonView(), ExternalLink() (+32 more)
...
Cohesion: 0.18
Nodes (10): ProviderCard(), RayProviderGrid(), SocialProviderGrid(), ALL_PROVIDERS, RAY_PROVIDERS, RayProviderInfo, SOCIAL_DETAIL, SOCIAL_PROVIDERS (+2 more)

### Community 114 - "connection.ts"
Cohesion: 0.27
...
### Community 118 - "queue/worker.ts"
Cohesion: 0.39
Nodes (5): worker, startWorkerHealthServer(), installShutdownHandlers(), startRunWorker(), getRunForWorker()

### Community 119 - "verify-proxy.ts"
Cohesion: 0.29
...
- **Why does `cn()` connect `cn` to `credentials-row.tsx`, `sidebar.tsx`, `profile-card.tsx`, `shape.ts`, `button.tsx`, `nav-user.tsx`, `data-table.tsx`, `toast.tsx`, `ingest.ts`, `app/layout.tsx`, `add-credential-dialog.tsx`, `query/runs.ts`, `select-credential.tsx`, `prompts/page.tsx`, `utils.ts`, `pagination.tsx`, `provider-mark.tsx`, `credentials-table.tsx`, `run-detail.tsx`, `run-models.tsx`, `lib/providers.ts`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `config` connect `config/index.ts` to `sidebar.tsx`, `logger.ts`, `ingest.ts`, `app/layout.tsx`, `query/runs.ts`, `chat.ts`, `catalog.ts`, `vault.ts`, `admission.ts`, `schemas.ts`, `run-logs.ts`, `auth-session.ts`, `logger`, `getDb`, `lib/settings.ts`, `rays.ts`, `db/index.ts`, `connection.ts`, `verify-ytdlp.ts`, `queue/worker.ts`, `verify-proxy.ts`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `getDb()` connect `getDb` to `lib/settings.ts`, `prompts/page.tsx`, `query/runs.ts`, `catalog.ts`, `lib/runs.ts`, `vault.ts`, `admission.ts`, `settings/page.tsx`, `db/index.ts`, `extraction/index.ts`, `schemas.ts`, `queue/worker.ts`, `auth-session.ts`?**
