...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "h-12 whitespace-nowrap px-4 text-start align-middle font-medium text-foreground [&:has([role=checkbox])]:pe-0",
        className,
      )}
      {...props}
    />
...
function TableCell({ className, ...props }: React.ComponentProps<"td">) {
  return (
    <td
      ...
      className={cn(
        "whitespace-nowrap px-4 py-3 align-middle [&:has([role=checkbox])]:pe-0",
        className,
      )}
      {...props}
    />
