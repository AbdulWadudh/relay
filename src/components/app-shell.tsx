...
export function ShellHeader({
  ...
  return (
    <header className="fade-in slide-in-from-top-2 z-10 flex h-16 shrink-0 animate-in items-center gap-3 border-b fill-mode-both px-6">
      <SidebarTrigger className="-ms-1 transition-all duration-200 hover:scale-110 hover:bg-emerald-500/10 hover:text-emerald-300" />
